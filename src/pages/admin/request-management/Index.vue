      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="overview_block_wrap lightgreygreen_bgcolor">
            ...
            <h4>Pending Request Approval</h4>
            <h3>0</h3>
          </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="overview_main_content_container">
      <div class="overview_main_table_container">
        ...
        <div class="main_table_wrap">
          <b-table striped hover responsive :per-page="perPage" :current-page="currentPage" :busy="tabelLoader"  :items="hotelsArr" :fields="fields">
            ...
            <template v-slot:cell(actions)="row">
              ...
              <div class="dash_view_btn" @click="changeStatus('accepted', row.item.propertyId)">
                ...
                <div class="dash_view_btn pl-2" @click="changeStatus('rejected',row.item.propertyId)">
